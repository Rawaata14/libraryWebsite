...
תיאור הקובץ:
שכבת השירות האחראית על שליחת הודעות דוא"ל (Emails) במערכת דרך Nodemailer.

אחריות:
- הגדרת ה-Transporter המרכזית לחיבור לשרת הדוא"ל.
- ניקוי והמרת תווי HTML מסוכנים למניעת פגיעויות (פונקציית escapeHtml).
- שליחת מיילים אופציונלית כך שכשל בשליחה אינו מפיל תהליכים ראשיים.
- שליחת מיילי ברכה למשתמשים חדשים שנרשמו למערכת.
- שליחת אישורי הזמנה וביטול עבור מקומות ישיבה בספרייה.
- שליחת אישורי השאלת ספרים למשתמשים.
=========================================================
*/
