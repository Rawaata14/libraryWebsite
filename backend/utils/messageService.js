...
תיאור הקובץ:
שכבת הלוגיקה העסקית לניהול פניות, שיחות והודעות בין קוראים/אורחים לבין ספרניות המערכת.

אחריות:
- נרמול טקסט ואימות קלט (כגון תקינות כתובת אימייל ואורכי הודעות מותרים).
- פתיחת שיחות ופניות חדשות למערכת עבור משתמשים רשומים ואורחים.
- שליחת התראות אוטומטיות לכלל הספרניות הפעילות על פניות או תגובות חדשות.
- הוספת תשובות לשיחות קיימות תוך אכיפת בקרת הרשאות (בעלות על השיחה / הרשאת ספרנית).
- ניהול מנגנון התגובות הכולל שליחת התראות פנימיות והודעות דוא"ל ייעודיות למשתמשים כאשר ספרנית משיבה לפנייתם.
=========================================================
*/
